...
const GalleryAndQuality = () => {
  ...
  const images = [
    ...
    { src: wastewater_consultancy, alt: "Wastewater Consultancy", title: "Wastewater Management" },
    { src: water_lab_testing, alt: "Water Lab Testing", title: "Laboratory Testing" },
    { src: Refreshing_the_planet, alt: "Refreshing The Planet", title: "Environmental Solutions" },
    { src: Adding_value_accross_sectors, alt: "Adding value across sectors", title: "Cross-Sector Solutions" },
    { src: Innovations, alt: "Innovations", title: "Innovative Technologies" },
    { src: water_services, alt: "Water Services", title: "Comprehensive Services" },
    { src: industrial_boiler_cleaning, alt: "Industrial boiler cleaning", title: "Industrial Maintenance" }
  ];
  ...
  const qualityFeatures = [
    {
      ...
      description: "State-of-the-art research facilities for continuous innovation and product development"
    },
    {
      icon: <Microscope className="w-12 h-12" />,
      title: "Wet Lab Analysis",
      description: "Comprehensive water sample analysis for customized solutions"
    },
    {
      icon: <BarChart2 className="w-12 h-12" />,
      title: "Continuous Monitoring",
      description: "Regular audits and performance evaluations to maintain quality standards"
    }
  ];
  ...
  const qualityStandards = [
    {
      ...
      content: "Every batch of raw materials undergoes comprehensive testing including purity analysis, contamination checks, and specification verification."
    },
    {
      title: "In-Process Quality Control",
      content: "Continuous monitoring of critical parameters during production, including pH, viscosity, density, and active ingredient concentration."
    },
    {
      title: "Finished Product Analysis",
      content: "Complete analysis of finished products including stability testing, performance verification, and compliance with specifications."
    },
    {
      title: "Documentation & Traceability",
      content: "Detailed batch records, analytical reports, and complete traceability from raw materials to finished products."
    }
  ];
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {technicalParameters.map((param, index) => (
              <TechnicalParameter
                ...
                onClick={() => setSelectedParameter(selectedParameter === index ? null : index)}
              />
            ))}
          </div>
          {selectedParameter !== null && (
            <div className="mt-8 bg-white rounded-xl p-6 shadow-lg animate-fadeIn">
              <h3 className="font-semibold text-xl mb-4">{technicalParameters[selectedParameter].title} Details</h3>
              <div className="grid md:grid-cols-2 gap-4">
                {technicalParameters[selectedParameter].details.map((detail, index) => (
            ...
            {performanceMetrics.map((metric, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="text-2xl font-bold text-[#90C418]">{metric.value}</div>
                </div>
              </div>
            ))}
          </div>
