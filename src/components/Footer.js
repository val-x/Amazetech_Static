    ...
    <footer className="bg-[#E8F6D5] px-4 sm:px-6 md:px-10 lg:px-20 pt-12 md:pt-20 pb-6 md:pb-10">
      <div className="container mx-auto">
        ...
        <h2 className="text-2xl sm:text-3xl font-serif text-center mb-8 md:mb-16 leading-relaxed px-4">
          ...
          <span className="text-[#90C418] font-semibold"> Precious Resources</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
            ...
            <div>
              ...
              <div className="space-y-2">
                <Link to="/" className="text-gray-600 hover:text-[#90C418] block text-sm sm:text-base">
                  Home
                </Link>
                <Link to="/about" className="text-gray-600 hover:text-[#90C418] block text-sm sm:text-base">
                  About
                </Link>
                <Link to="/service" className="text-gray-600 hover:text-[#90C418] block text-sm sm:text-base">
                  Services
                </Link>
                <Link to="/contact" className="text-gray-600 hover:text-[#90C418] block text-sm sm:text-base">
                  Contact
                </Link>
              </div>
            </div>
            ...
            <div className="col-span-1 sm:col-span-2 md:col-span-1">
              ...
              <div className="space-y-2 text-sm sm:text-base">
                <Link to="/products/boilerTreatment" className="text-gray-600 hover:text-[#90C418] block">
                  Boiler Treatment Chemicals
                </Link>
                <Link to="/products/coolingTower" className="text-gray-600 hover:text-[#90C418] block">
                  Cooling Tower Treatment Chemicals
                </Link>
                <Link to="/products/chillerTreatment" className="text-gray-600 hover:text-[#90C418] block">
                  Chiller Treatment Chemicals
                </Link>
                <Link to="/products/roTreatment" className="text-gray-600 hover:text-[#90C418] block">
                  RO Treatment Chemicals
                </Link>
                <Link to="/products/defoamers" className="text-gray-600 hover:text-[#90C418] block">
                  Defoamers
                </Link>
                <Link to="/products/paperAndSugar" className="text-gray-600 hover:text-[#90C418] block">
                  Paper & Sugar Processing Chemicals
                </Link>
                <Link to="/products/miningConstruction" className="text-gray-600 hover:text-[#90C418] block">
                  Mining & Construction Water Treatment
                </Link>
                <Link to="/products/etpTreatment" className="text-gray-600 hover:text-[#90C418] block">
                  ETP Treatment Chemicals
                </Link>
                <Link to="/products/stpTreatment" className="text-gray-600 hover:text-[#90C418] block">
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-600 max-w-full text-sm sm:text-base">
                ...
                <div className="break-all">
                  <a href="mailto:amazetechcrpn999@gmail.com" className="text-blue-600 hover:underline">
