      ...
      <main className="max-w-6xl mx-auto space-y-6">
        ...
        <section>
          <p className='mb-10 w-[70%]'>
            Our comprehensive water treatment solutions are designed to optimize your system's performance 
            while protecting valuable equipment from scale, corrosion, and biological fouling. We provide 
            tailored chemical treatment programs that ensure maximum efficiency, reduce operational costs, 
            and maintain environmental compliance. Our expert team delivers innovative solutions for 
            industrial water systems including boilers, cooling towers, and process water applications.
          </p>
